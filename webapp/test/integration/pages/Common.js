sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("ru/rosneft/Cost/app", ".html");
		...
		return Opa5.extend("ru.rosneft.Cost.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["ru/rosneft/Cost/localService/mockserver"], function (mockserver) {
